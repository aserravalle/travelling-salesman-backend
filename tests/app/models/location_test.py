...
def test_location_creation_with_address():
    ...
    assert loc.latitude == 41.9000  # Placeholder value
    assert loc.longitude == 12.5000  # Placeholder value
    assert loc.address == "Piazza del Colosseo, 1, 00184 Roma RM, Italy"
