...
class Salesman(BaseModel):
    ...
    current_location: Optional[Location] = (
        None  # current location of the salesman during job assignment
    )
    current_time: Optional[datetime] = (
        None  # current datetime of the salesman during job assignment
    )
    time_worked_mins: Optional[int] = (
        0  # how long the salesman has already worked today
    )
